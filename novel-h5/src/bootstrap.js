...
const fallback = { link: import.meta.env?.DEV ? { code:"hello", entry_story_slug:"", time_spent_threshold:0 } : null, ticket:"", surface:"novel", cookie_enabled:false, meta_measurement:false, locale:"en", available_locales:["en"], error:null };
